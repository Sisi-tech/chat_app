...
class MessageWindow(tk.Canvas):
    def __init__(self, container, *args, **kwargs):
        ...
        self.message_frame.columnconfigure(0, weight=0)
    ...
    def _create_message_container(self, message_content, message_time, message_labels):
        ...
        def reconfigure_message_labels(event):
            for lable, _ in message_labels:
                lable.configure(wraplength=min(container.winfo_width() - 130, MAX_MESSAGE_WIDTH))
    ...
    def _create_message_bubble(self, container, message_content, message_time, message_labels):
        avatar_image = Image.open("/Users/sisiwang/Documents/Project/Chat app with Tkinter/chat.png")
